...
def main(table: str, year: int):
    ...
    silver_path = os.environ["SILVER_DELTA_PATH"] + table
    ...
    dq_runs_path = os.environ["DQ_DELTA_PATH"] + "dq_runs"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--table", required=True, help="Silver Table Name (ex: circuits)")
