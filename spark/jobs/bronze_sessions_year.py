...
def main(year: int) -> None:
    spark = SparkSession.builder.appName(f"bronze_ingest_sessions").getOrCreate()
    ...
    url, params_used, http_status, payload = fetch_json("sessions", params={"year": year})
    ...
    console_log_ingestion("sessions", df, output_path, request_id)
    spark.stop()
